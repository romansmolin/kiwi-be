...
const characters = [
    {
      name: 'Тролль',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803809/Troll_vkblcv.png',
      description: 'Тролль, который заставит всех смеяться своими проделками и веселыми историями!'
    },
    {
      name: 'Единорог с крыльями',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803794/Edinorog_rb9gb1.png',
      description: 'Магический единорог с крыльями, который принесет сказку и волшебство на ваш праздник!'
    },
    {
      name: 'Фиксики',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803795/fiksiki_deswix.png',
      description: 'Фиксики всегда готовы починить любую игрушку и устроить веселую игру!'
    },
    {
      name: 'Гонщик',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803793/Driver_zagajf.png',
      description: 'Гонщик, который устроит захватывающие гонки и соревнования для всех!'
    },
    {
      name: 'Человек-паук',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803803/Pauk_m7jnl5.png',
      description: 'Человек-паук спасет праздник и покажет крутые паутины и трюки!'
    },
    {
      name: 'Трансформер',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803804/super_oqltcu.png',
      description: 'Трансформер, который удивит всех своими превращениями и защитит всех гостей!'
    },
    {
      name: 'Пираты',
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803804/pirat_urfxhu.png',
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/dgh3hceyt/image/upload/v1718803792/dino_puf7tl.png',
